...
export default class FllowOrderHistory extends Core {
  constructor(config) {
    super(config);
    ...
    //优化防止二次获取数据
    this.subscribe("order:SendOrderHistory",this.getOrderListFromOrder,this);
    this._bind();
  }
  ...
  getOrderListFromOrder(data){
    ...
    var list = data && data.list || [];
      ...
      $(".J_FllowOrderHistoryNum").text(gendanList.length)
      this._sort({
