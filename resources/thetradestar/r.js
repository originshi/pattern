...
function getMobileRegisterLink() {
    return "http://t.thetradestar.com/thetradestar/s/my-guide/thetradestar/register.html?inviteCode=&from=webtrade";
}

// 白标的LOGO地址, 最好是http
function getLogoUrl() {
    // return "../../img/xinwaihui/logo.png";
    return "http://wt-thetradestar.thetradestar.com/v2/thetradestar/img/wl/thetradestar/pay.png";
}
...
// 注册souifbssaoe
function getRegisterSouifbssssssaoe() {
    return "webtrade";
}

// 网页注册的邀请人
function getRegisterRefethetradestarode() {
    return "";
}
...
function getRegisterDefaultNickname() {
    ...
    var nickname = 'thetradestar_' + minite + '' + second + '' + millsecond;
    return nickname;
}
...
function getTradePageUrl() {
    return 'http://wt-thetradestar.thetradestar.com/v2/thetradestar/s/webtrade/trade.html';
}

// PC版注册页面的地址 (需要iframe)
function getRegisterPageUrl() {
    return 'http://wt-thetradestar.thetradestar.com/v2/thetradestar/s/webtrade/register.html';
}

// PC版入金页面 (需要iframe)
function getDepositButtonHref() {
    return "http://p.thetradestar.com/thetradestar/deposit.html";
}

// PC 版查看支持银行bank-list (需要iframe)
function getBankListHref() {
    return "http://wt-thetradestar.thetradestar.com/v2/thetradestar/s/pay/bank-list.html";
}
...
function getGroupPriceUrl() {
    return 'http://price.thetradestar.com/v1/price/current';
}

//ajax.js: priceUrl
function getPriceUrl() {
    return 'http://price.thetradestar.com/v2/price/current';
}

//ajax.js: candleUrl
function getCandleUrl() {
    return 'http://price.thetradestar.com/v3/price/candle';
}

//ajax请求前缀：正式环境
function getAjaxPrefix() {
    return 'http://api.thetradestar.com';
}

//邀请链接
function getInvitePrefix() {
    return 'http://t.thetradestar.com/i/';
}

//安卓分享前缀
function getAndroidSharePrefix() {
    return 'http://t.thetradestar.com';
}

//头像链接
function getAvatarUrl() {
    return 'http://static.thetradestar.com/';
}

//stompUrl
function getStompUrl() {
    return 'wss://price.thetradestar.com:61615/stomp';
}

//frame.js 147 
function getFrameIndexofUrl() {
    return 't.thetradestar.com';
}

//chart/index.js : UDFCompatibleDatafeed( ..url )
function getUDFCompatibleDatafeedUrl() {
    return 'http://price.thetradestar.com/tradingview';
}
function getQuoteHelperUrl() {
    return 'ws://price.thetradestar.com:61614/stomp';
}
function getChartStorageUrl() {
    return 'http://api.thetradestar.com/v1/advchart';
}

//zhufeng\cooperation\index.js 109
function getFeedbackUrl() {
    return 'http://api.thetradestar.com/v1/feedback/';
}
...
function getStatementContent() {
    return '<h2>thetradestar</h2>\
            <p>thetradestar是由顶尖交易服务团队为初入市场的投资者量身打造的交易学习产品。全球首创的声控交易，喊“涨” “跌”便可下单，极优化了交易体验，并在交易中融入学习模式，让初级投资者轻松掌握技巧，成为投资达人。 thetradestar金融致力于为投资者搭建更简单、更安全、更便捷的学习环境，引导投资者步步为赢的完成交易！</p>\
            <div class="believe">\
                <p>我们相信，学习投资可以很简单！</p>\
                <p>我们知道，交易决策可以更轻松！</p>\
                <p>我们提供，全球高手供参考！</p>\
            ...
            <div>\
                <p>thetradestar金融是一家为零售及机构客户提供外汇交易及相关服务的主要环球供应商。</p>\
            </div>\
            <div>\
                <p>客户资金隔离存放: </p>\
                <p>所有thetradestar金融的零售客户的资金必须与公司自身资金完全隔离，并单独放置于全球顶级银行。同时我们还与每家银行建立信托担保，以确保客户资金与银行资产隔离，不被用作银行的投资操作。</p>\
            </div>\
            <div>\
                <p>优势与特点: </p>\
...
function getRiskMsg () {
    return '<p class="marginTop">尊敬的thetradestar金融客户:</p>\
    <p class="marginTop txtIndent">thetradestar金融交易平台(以下统一使用"我平台"代替)的业务是一种潜在收益和潜在风险较高的投资业务,对投资者的风险承受能力、理解风险程度、风险控制能力以及投资经验有较高的要求。存入资金前，您需要仔细阅读以下高风险揭示协议。</p>\
...
function getTrueMsg() {
    ...
    <div>\
        <div>尊敬的thetradestar金融客户:</div>\
        <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;尊敬的thetradestar金融(以下简称"我司")客户我们会间接为您提供电子商务平台支付服务,您拥有平台账户资金的使用所有权，您需要在我司交易平台注册账户并上传相关个人资料，您应接受我司对您资金结算的管理监督和检查。</div>\
...
function getAbountTitleContent() {
    return '<h2 class="desc-title">我们提供适合不同水平投资者的投资教育系统一站解决方案</h2>\
            <div class="desc-content">\
                <p>获客汇聚来自各大互联网, 金融公司的行业精英, 专注于通过产品, 科技改变金融行业.</p>\
