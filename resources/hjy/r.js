...
function getMobileRegisterLink() {
    return "https://wt-q.invhero.com/hjy/s/my-guide/hjy/register.html?refer=/i/yfn2s2&from=webtrade";
}
...
function getLogoUrl() {
    ...
    return "https://wt-q.invhero.com/hjy/img/wl/hjy_about.png";
}
...
function getTradePageUrl() {
    return 'http://w.hjy.cc/wt.html';
}

// PC版注册页面的地址 (需要iframe)
function getRegisterPageUrl() {
    return 'http://w.hjy.cc/register.html';
}

// PC版入金页面 (需要iframe)
function getDepositButtonHref() {
    return "http://p.hjy.cc/deposit.html";
}

// PC 版查看支持银行bank-list (需要iframe)
function getBankListHref() {
    return "https://wt-hjy.invhero.com/hjy/s/pay/bank-list.html";
}
...
function getRiskMsg () {
    return '<p class="marginTop">尊敬的好交易客户:</p>\
    <p class="marginTop txtIndent">好交易交易平台(以下统一使用"我平台"代替)的业务是一种潜在收益和潜在风险较高的投资业务,对投资者的风险承受能力、理解风险程度、风险控制能力以及投资经验有较高的要求。存入资金前，您需要仔细阅读以下高风险揭示协议。</p>\
...
function getTrueMsg() {
    ...
    <div>\
        <div>尊敬的好交易客户:</div>\
        <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;尊敬的好交易(以下简称"我司")客户我们会间接为您提供电子商务平台支付服务,您拥有平台账户资金的使用所有权，您需要在我司交易平台注册账户并上传相关个人资料，您应接受我司对您资金结算的管理监督和检查。</div>\
...
function getAbountTitleContent() {
    return '<h2 class="desc-title">我们提供适合不同水平投资者的投资教育系统一站解决方案</h2>\
            <div class="desc-content">\
                <p>好交易汇聚来自各大互联网, 金融公司的行业精英, 专注于通过产品, 科技改变金融行业.</p>\
