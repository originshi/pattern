...
function getMobileRegisterLink() {
    return "http://t.hwplayer.com/hwbj/s/my-guide/hwbj/register.html?refer=/i/&from=webtrade";
}
...
function getIsThirdPartyPayUrl() {
    return '/v1/user/pay/deposit_superstarpay_order/'
}
...
function getHomeUrl() {
    return "http://wt-hwplayer.hwplayer.com/";
}

// 白标的LOGO地址, 最好是http
function getLogoUrl() {
    // return "../../img/xinwaihui/logo.png";
    return "http://wt-hwplayer.hwplayer.com/v2/hwbj/img/wl/hwbj_about.png";
}
...
function getTradePageUrl() {
    return 'http://w.hwplayer.cc/wt.html';
}

// PC版注册页面的地址 (需要iframe)
function getRegisterPageUrl() {
    return 'http://w.hwplayer.cc/register.html';
}

// PC版入金页面 (需要iframe)
function getDepositButtonHref() {
    return "http://wt-hwplayer.hwplayer.com/v2/hwbj/s/pay/guide.html";
}

// PC 版查看支持银行bank-list (需要iframe)
function getBankListHref() {
    return "http://wt-hwplayer.hwplayer.com/v2/hwbj/s/pay/bank-list.html";
}

//ajax.js: groupPriceUrl
function getGroupPriceUrl() {
    return 'http://price.hwplayer.com/v1/price/current';
}

//ajax.js: priceUrl
function getPriceUrl() {
    return 'http://price.hwplayer.com/v2/price/current';
}

//ajax.js: candleUrl
function getCandleUrl() {
    return 'http://price.hwplayer.com/v3/price/candle';
}

//ajax请求前缀：正式环境
function getAjaxPrefix() {
    return 'http://api.hwplayer.com';
}

//邀请链接
function getInvitePrefix() {
    return 'http://t.hwplayer.com/i/';
}

//安卓分享前缀
function getAndroidSharePrefix() {
    return 'http://t.hwplayer.com';
}

//头像链接
function getAvatarUrl() {
    return 'http://static.hwplayer.com/';
}

//stompUrl
function getStompUrl() {
    return 'ws://price.hwplayer.com:61613/stomp';
}

//frame.js 147 
function getFrameIndexofUrl() {
    return 't.hwplayer.com';
}

//chart/index.js : UDFCompatibleDatafeed( ..url )
function getUDFCompatibleDatafeedUrl() {
    return 'http://price.hwplayer.com/tradingview';
}
function getQuoteHelperUrl() {
    return 'ws://price.hwplayer.com:61613/stomp';
}
function getChartStorageUrl() {
    return 'http://api.hwplayer.com/v1/advchart';
}

//zhufeng\cooperation\index.js 109
function getFeedbackUrl() {
    return 'http://api.hwplayer.com/v1/feedback/';
}
...
function getRiskMsg () {
    return '<p class="marginTop">尊敬的汇玩客户:</p>\
    <p class="marginTop txtIndent">汇玩交易平台(以下统一使用"我平台"代替)的业务是一种潜在收益和潜在风险较高的投资业务,对投资者的风险承受能力、理解风险程度、风险控制能力以及投资经验有较高的要求。存入资金前，您需要仔细阅读以下高风险揭示协议。</p>\
    ...
    <p>6.风险警示：</p>\
    <p class="txtIndent"> 1）交易客户有义务保管汇玩账号、密码，避免泄露，因保管不善导致交易账号、密码泄露而引起的风险由交易客户自行承担。</p>\
...
function getTrueMsg() {
    ...
    <div>\
        <div>尊敬的汇玩客户:</div>\
        <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;尊敬的汇玩(以下简称"我司")客户我们会间接为您提供电子商务平台支付服务,您拥有平台账户资金的使用所有权，您需要在我司交易平台注册账户并上传相关个人资料，您应接受我司对您资金结算的管理监督和检查。</div>\
...
function getAbountTitleContent() {
    return '<h2 class="desc-title">我们提供适合不同水平投资者的投资教育系统一站解决方案</h2>\
            <div class="desc-content">\
                <p>汇玩汇聚来自各大互联网, 金融公司的行业精英, 专注于通过产品, 科技改变金融行业.</p>\
...
function getIndexLogoUrl() {
    return '../../img/wl/huiwan/index_logo.jpg';
}
