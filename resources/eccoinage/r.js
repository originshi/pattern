...
function getMobileRegisterLink() {
    return "http://t-eccoinage.eccoinage.com/eccoinage/s/my-guide/eccoinage/register.html?inviteCode=&from=webtrade";
}

// 白标的LOGO地址, 最好是http
function getLogoUrl() {
    // return "../../img/xinwaihui/logo.png";
    return "http://wt-eccoinage.eccoinage.com/eccoinage/img/wl/eccoinage/eccoinage_aboutus.png";
}
...
function getRegisterDefaultNickname() {
    ...
    var nickname = 'eccoinage_' + minite + '' + second + '' + millsecond;
    return nickname;
}
...
function getTradePageUrl() {
    return 'http://wt-eccoinage.eccoinage.com/eccoinage/s/webtrade/trade.html';
}

// PC版注册页面的地址 (需要iframe)
function getRegisterPageUrl() {
    return 'http://wt-eccoinage.eccoinage.com/eccoinage/s/webtrade/register.html';
}

// PC版入金页面 (需要iframe)
function getDepositButtonHref() {
    return "http://wt-eccoinage.eccoinage.com/eccoinage/s/pay/guide.html";
}

// PC 版查看支持银行bank-list (需要iframe)
function getBankListHref() {
    return "http://wt-eccoinage.eccoinage.com/eccoinage/s/pay/bank-list.html";
}
...
function getInvitePrefix() {
    return 'http://t.eccoinage.com/i/';
}

//安卓分享前缀
function getAndroidSharePrefix() {
    return 'http://t.eccoinage.com';
}
...
function getStatementContent() {
    return '<h2>易創錢</h2>\
            <p>易創錢是由顶尖交易服务团队为初入市场的投资者量身打造的交易学习产品。全球首创的声控交易，喊“涨” “跌”便可下单，极优化了交易体验，并在交易中融入学习模式，让初级投资者轻松掌握技巧，成为投资达人。 易創錢致力于为投资者搭建更简单、更安全、更便捷的学习环境，引导投资者步步为赢的完成交易！</p>\
            <div class="believe">\
                <p>我们相信，学习投资可以很简单！</p>\
                <p>我们知道，交易决策可以更轻松！</p>\
                <p>我们提供，全球高手供参考！</p>\
            ...
            <div>\
                <p>易創錢是一家为零售及机构客户提供外汇交易及相关服务的主要环球供应商。</p>\
            </div>\
            <div>\
                <p>客户资金隔离存放: </p>\
                <p>所有易創錢的零售客户的资金必须与公司自身资金完全隔离，并单独放置于全球顶级银行。同时我们还与每家银行建立信托担保，以确保客户资金与银行资产隔离，不被用作银行的投资操作。</p>\
            </div>\
            <div>\
                <p>优势与特点: </p>\
...
function getRiskMsg () {
    return '<p class="marginTop">尊敬的易創錢客户:</p>\
    <p class="marginTop txtIndent">易創錢交易平台(以下统一使用"我平台"代替)的业务是一种潜在收益和潜在风险较高的投资业务,对投资者的风险承受能力、理解风险程度、风险控制能力以及投资经验有较高的要求。存入资金前，您需要仔细阅读以下高风险揭示协议。</p>\
...
function getTrueMsg() {
    ...
    <div>\
        <div>尊敬的易創錢客户:</div>\
        <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;尊敬的易創錢(以下简称"我司")客户我们会间接为您提供电子商务平台支付服务,您拥有平台账户资金的使用所有权，您需要在我司交易平台注册账户并上传相关个人资料，您应接受我司对您资金结算的管理监督和检查。</div>\
...
function getAbountTitleContent() {
    return '<h2 class="desc-title">我们提供适合不同水平投资者的投资教育系统一站解决方案</h2>\
            <div class="desc-content">\
                <p>eccoinage汇聚来自各大互联网, 金融公司的行业精英, 专注于通过产品, 科技改变金融行业.</p>\
...
function getIndexLogoUrl() {
    return '../../img/wl/eccoinage/index_logo.jpg';
}
