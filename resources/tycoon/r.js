...
function getMobileRegisterLink() {
    return "http://t.jyec99.com/tycoon/s/my-guide/tycoon/register.html?refer=/i/y58bd2&from=webtrade";
}

// 白标的LOGO地址, 最好是http
function getLogoUrl() {
    // return "../../img/xinwaihui/logo.png";
    return "http://t.jyec99.com/tycoon/img/wl/tycoon_aboutus.png";
}
...
function getRegisterDefaultNickname() {
    ...
    var nickname = '大亨_' + minite + '' + second + '' + millsecond;
    return nickname;
}
...
function getTradePageUrl() {
    return 'http://wt-jiaoyidaheng.jyec99.com/v2/tycoon/s/webtrade/trade.html';
}

// PC版注册页面的地址 (需要iframe)
function getRegisterPageUrl() {
    return 'http://wt-jiaoyidaheng.jyec99.com/v2/tycoon/s/webtrade/register.html';
}

// PC版入金页面 (需要iframe)
function getDepositButtonHref() {
    return "http://wt-jiaoyidaheng.jyec99.com/v2/tycoon/s/pay/guide.html";
}

// PC 版查看支持银行bank-list (需要iframe)
function getBankListHref() {
    return "http://wt-jiaoyidaheng.jyec99.com/v2/tycoon/s/pay/bank-list.html";
}

function getDefaultAvatarUrl() {
    return "http://wt-jiaoyidaheng.jyec99.com/v2/tycoon/img/wl/tycoon/tycoon_aboutus.png";
}

function getHomeUrl() {
    return "http://www.jyec99.com/";
}
...
function getGroupPriceUrl() {
    return 'http://price.jyec99.com/v1/price/current';
}

//ajax.js: priceUrl
function getPriceUrl() {
    return 'http://price.jyec99.com/v2/price/current';
}

//ajax.js: candleUrl
function getCandleUrl() {
    return 'http://price.jyec99.com/v3/price/candle';
}

//ajax请求前缀：正式环境
function getAjaxPrefix() {
    return 'http://api.jyec99.com';
}

//邀请链接
function getInvitePrefix() {
    return 'http://t.jyec99.com/i/';
}

//安卓分享前缀
function getAndroidSharePrefix() {
    return 'http://t.jyec99.com';
}

//头像链接
function getAvatarUrl() {
    return 'http://static.jyec99.com/';
}

//stompUrl
function getStompUrl() {
    return 'ws://price.jyec99.com:61613/stomp';
}
...
function getUDFCompatibleDatafeedUrl() {
    return 'http://price.jyec99.com/tradingview';
}
function getQuoteHelperUrl() {
    return 'ws://price.jyec99.com:61613/stomp';
}
function getChartStorageUrl() {
    return 'http://api.jyec99.com/v1/advchart';
}

//zhufeng\cooperation\index.js 109
function getFeedbackUrl() {
    return 'http://api.jyec99.com/v1/feedback/';
}
...
function getExtraHtml() {
    return '\
        ...
        <p>3.入金手续费：0.8%。</p>\
        <p>4.存款客户姓名必须与中国银联卡持卡人姓名相同，前述资料的任何差异都可能造成您的交易被拒绝。</p>\
        <p>5.交易完成后，请保留交易编号作为备档。</p>\
        <p>6.通常在收到客户款项后15分钟内存入客户交易账户。</p>\
        <p>7.交易结算只限使用银联卡。</p>\
        <p>8.每次最低交易金额为500美元，每次最高交易金额为30,000美元。</p>\
    ';
}

function getStatementContent() {
    return '<h2>交易大亨</h2>\
            <p>交易大亨是由顶尖交易服务团队为初入市场的投资者量身打造的交易学习产品。全球首创的声控交易，喊“涨” “跌”便可下单，极优化了交易体验，并在交易中融入学习模式，让初级投资者轻松掌握技巧，成为投资达人。 掌迭英豪致力于为投资者搭建更简单、更安全、更便捷的学习环境，引导投资者步步为赢的完成交易！</p>\
            <div class="believe">\
                <p>我们相信，学习投资可以很简单！</p>\
                <p>我们知道，交易决策可以更轻松！</p>\
                <p>我们提供，全球高手供参考！</p>\
            ...
            <div>\
                <p>交易大亨是一家为零售及机构客户提供外汇交易及相关服务的主要环球供应商。</p>\
            </div>\
            <div>\
                <p>客户资金隔离存放: </p>\
                <p>根据新西兰FSP规定，所有交易大亨的零售客户的资金必须与公司自身资金完全隔离，并单独放置于全球顶级银行。同时我们还与每家银行建立信托担保，以确保客户资金与银行资产隔离，不被用作银行的投资操作。</p>\
            </div>\
            <div>\
                <p>优势与特点: </p>\
...
function getOutlookParams() {
    return {
        ...
        "mainSeriesProperties.barStyle.downColor": "#00FF00",
        "mainSeriesProperties.hollowCandleStyle.upColor": "#FF0000",
        "mainSeriesProperties.hollowCandleStyle.downColor": "#00FF00"
    };
}
...
function getRiskMsg () {
    return '<p class="marginTop">尊敬的交易大亨客户:</p>\
    <p class="marginTop txtIndent">交易大亨交易平台(以下统一使用"我平台"代替)的业务是一种潜在收益和潜在风险较高的投资业务,对投资者的风险承受能力、理解风险程度、风险控制能力以及投资经验有较高的要求。存入资金前，您需要仔细阅读以下高风险揭示协议。</p>\
...
function getTrueMsg() {
    ...
    <div>\
        <div>尊敬的交易大亨客户:</div>\
        <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;尊敬的交易大亨(以下简称"我司")客户我们会间接为您提供电子商务平台支付服务,您拥有平台账户资金的使用所有权，您需要在我司交易平台注册账户并上传相关个人资料，您应接受我司对您资金结算的管理监督和检查。</div>\
...
function getAbountTitleContent() {
    return '<h2 class="desc-title">我们提供适合不同水平投资者的投资教育系统一站解决方案</h2>\
            <div class="desc-content">\
                <p>交易大亨汇聚来自各大互联网, 金融公司的行业精英, 专注于通过产品, 科技改变金融行业.</p>\
...
function getIndexLogoUrl() {
    return '../../img/wl/tycoon/index_logo.jpg';
}
